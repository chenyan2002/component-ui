...
let exports1GenerateAst;

function generateAst(arg0) {
  var val0 = arg0;
  var len0 = val0.byteLength;
  var ptr0 = realloc1(0, 0, 1, len0 * 1);
  var src0 = new Uint8Array(val0.buffer || val0, val0.byteOffset, len0 * 1);
  (new Uint8Array(memory0.buffer, ptr0, len0 * 1)).set(src0);
  const ret = exports1GenerateAst(ptr0, len0);
  let variant3;
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./bindgen.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./bindgen.core2.wasm', import.meta.url));
    ...
    postReturn0 = exports1['cabi_post_generate-ast'];
    exports1GenerateAst = exports1['generate-ast'];
  })();
