...
(async () => {
  ...
  function Lt(r, e, t) {
    e === "." && zt && ma(zt[0]) === r && (e = Mr, e.startsWith("/") && e !== "/" && (e = e.slice(1)));
    let n = r, a;
    do {
  ...
  let Fr = class {
    ...
    readViaStream(e) {
      const t = nt(__privateGet(this, _e));
      let n = Number(e);
      return new pa({
        blockingRead(a) {
    ...
    read(e, t) {
      const n = nt(__privateGet(this, _e));
      return [
        n.slice(t, t + e),
        t + e >= n.byteLength
      ];
    ...
    statAt(e, t) {
      const n = Lt(__privateGet(this, _e), t, {
        create: false,
        directory: false
      });
    ...
    openAt(e, t, n, a, i) {
      const d = Lt(__privateGet(this, _e), t, n);
      return new _a2(d);
    }
    readlinkAt() {
  ...
  const rr = {
    ...
    value: "Module"
  })), { InputStream: Pr, OutputStream: pt } = Ye, sr = Symbol.dispose ?? Symbol.for("dispose");
  let Wr = [], Dr = [], Vr = "/";
  function Aa(r) {
    Wr = Object.entries(r);
  }
  ...
  const Ta = new Ke(), _a = new Ke(), Ba = new cr(), Gr = {
    TerminalInput: cr
  }, Jr = {
    TerminalOutput: Ke
  }, Yr = {
  ...
  const $a = {
    insecureSeed() {
      return Ft === void 0 && (Ft = be.getRandomU64(), Br = be.getRandomU64()), [
        Ft,
        Br
      ];
    }
    ...
    getRandomBytes(r) {
      ...
      if (r > Nt) for (var t = 0; t < r; t += Nt) crypto.getRandomValues(e.subarray(t, t + Nt));
    ...
    insecureRandom() {
      return Mt === void 0 && (Mt = be.getRandomU64(), _r = be.getRandomU64()), [
        Mt,
        _r
      ];
    }
    ...
    value: "Module"
  })), { getEnvironment: Oa } = bt, { exit: Sa } = ar, { getStderr: Ra } = ir, { getStdin: La } = nr, { getStdout: Na } = or, { TerminalInput: Xt } = Gr, { TerminalOutput: lt } = Jr, { getTerminalStderr: Ma } = Yr, { getTerminalStdin: Fa } = qr, { getTerminalStdout: Qa } = Kr, { getDirectories: Ua } = rr, { Descriptor: z, DirectoryEntryStream: ut, filesystemErrorCode: Pa } = ct, { Error: ve } = Kt, { InputStream: Ue, OutputStream: ae } = Ye, { getRandomBytes: Wa } = be, Cr = (r) => WebAssembly.compile(typeof Buffer < "u" ? Buffer.from(r, "base64") : Uint8Array.from(atob(r), (e) => e.charCodeAt(0)));
  ...
  }, w = [], Qt = new DataView(new ArrayBuffer());
  const u = (r) => Qt.buffer === r.buffer ? Qt : Qt = new DataView(r.buffer), Va = typeof process < "u" && process.versions && process.versions.node;
  let Ut;
  async function jr(r) {
    return Va ? (Ut = Ut || await fe(() => import("./__vite-browser-external-BIHI7g3E.js"), []), WebAssembly.compile(await Ut.readFile(r))) : fetch(r).then(WebAssembly.compileStreaming);
  }
  function P(r) {
  ...
  const za = Object.prototype.hasOwnProperty, ot = WebAssembly.instantiate, G = 1 << 30;
  function Q(r, e) {
    const t = r[0] & -1073741825;
    return t === 0 ? (r.push(0), r.push(e | G), (r.length >> 1) - 1) : (r[0] = r[t << 1], r[t << 1] = 0, r[(t << 1) + 1] = e | G, t);
  }
  function Ne(r, e) {
    const t = r[e << 1], n = r[(e << 1) + 1], a = (n & G) !== 0, i = n & -1073741825;
    if (n === 0 || (t & G) !== 0) throw new TypeError("Invalid handle");
    return r[e << 1] = r[0] | G, r[0] = e | G, {
      rep: i,
      scope: t,
      own: a
    };
  ...
  let ts = 0;
  function Ka(r, e) {
    var t = r, n = J[(t << 1) + 1] & -1073741825, a = Z.get(n);
  ...
  function rn(r, e, t, n, a) {
    var i = r, d = J[(i << 1) + 1] & -1073741825, f = Z.get(d);
    ...
    switch (A.tag) {
      ...
      case "err": {
        ...
        switch (_) {
          ...
          default:
            throw S instanceof Error && console.error(S), new TypeError(`"${_}" is not one of the cases of error-code`);
        }
        u(l).setInt8(a + 8, T, true);
        break;
      }
      default:
        throw new TypeError("invalid variant specified for result");
  ...
  function sn(r, e, t) {
    var n = r, a = J[(n << 1) + 1] & -1073741825, i = Z.get(a);
  ...
  function cn(r, e) {
    ...
    switch (d.tag) {
      case "ok": {
        const o = d.val;
        if (u(l).setInt8(e + 0, 0, true), !(o instanceof ut)) throw new TypeError('Resource error: Not a valid "DirectoryEntryStream" resource.');
        var f = o[g];
        if (!f) {
          const s = o[j] || ++on;
          dt.set(s, o), f = Q(lr, s);
    ...
    switch (d.tag) {
      case "ok": {
        ...
        if (h == null) u(l).setInt8(e + 32, 0, true);
          ...
          var { seconds: v, nanoseconds: _ } = U;
          u(l).setBigInt64(e + 40, V(v), true), u(l).setInt32(e + 48, $e(_), true);
        }
        var S = c;
        if (S == null) u(l).setInt8(e + 56, 0, true);
          ...
          var { seconds: T, nanoseconds: ee } = U;
          u(l).setBigInt64(e + 64, V(T), true), u(l).setInt32(e + 72, $e(ee), true);
        }
        var R = y;
  ...
  function un(r, e, t, n, a) {
    ...
    switch (A.tag) {
      case "ok": {
        const Y = A.val;
        u(l).setInt8(a + 0, 0, true);
        var { type: h, linkCount: v, size: _, dataAccessTimestamp: S, dataModificationTimestamp: T, statusChangeTimestamp: ee } = Y, R = h;
        let E;
        switch (R) {
          case "unknown": {
            E = 0;
        ...
        u(l).setInt8(a + 8, E, true), u(l).setBigInt64(a + 16, V(v), true), u(l).setBigInt64(a + 24, V(_), true);
        var I = S;
        if (I == null) u(l).setInt8(a + 32, 0, true);
        else {
          const _e2 = I;
          u(l).setInt8(a + 32, 1, true);
          var { seconds: Ee, nanoseconds: le } = _e2;
        ...
        if (x == null) u(l).setInt8(a + 56, 0, true);
          ...
          var { seconds: b, nanoseconds: U } = _e2;
          u(l).setBigInt64(a + 64, V(b), true), u(l).setInt32(a + 72, $e(U), true);
        }
        var Te = ee;
        if (Te == null) u(l).setInt8(a + 80, 0, true);
        else {
          const _e2 = Te;
          u(l).setInt8(a + 80, 1, true);
          var { seconds: He, nanoseconds: Ze } = _e2;
  ...
  function dn(r, e, t, n, a, i, d) {
    var f = r, p = J[(f << 1) + 1] & -1073741825, o = Z.get(p);
  ...
  function fn(r, e) {
    var t = r, n = lr[(t << 1) + 1] & -1073741825, a = dt.get(n);
    a || (a = Object.create(ut.prototype), Object.defineProperty(a, g, {
      writable: true,
      value: t
    }), Object.defineProperty(a, j, {
      writable: true,
  ...
  function gn(r) {
    ...
    if (t == null) u(l).setInt8(r + 0, 0, true);
      ...
      const a = t;
      if (u(l).setInt8(r + 0, 1, true), !(a instanceof Xt)) throw new TypeError('Resource error: Not a valid "TerminalInput" resource.');
      var n = a[g];
      if (!n) {
        const i = a[j] || ++wn;
        Ht.set(i, a), n = Q(rs, i);
  ...
  function In(r) {
    ...
    if (t == null) u(l).setInt8(r + 0, 0, true);
      ...
      const a = t;
      if (u(l).setInt8(r + 0, 1, true), !(a instanceof lt)) throw new TypeError('Resource error: Not a valid "TerminalOutput" resource.');
      var n = a[g];
      if (!n) {
        const i = a[j] || ++ss;
        ft.set(i, a), n = Q(ur, i);
  ...
  function _n(r) {
    const e = Ne(lr, r);
    if (e.own) {
      const t = dt.get(e.rep);
      t ? (t[H] && t[H](), dt.delete(e.rep)) : ut[X] && ut[X](e.rep);
    }
  }
  function Bn(r) {
    const e = Ne(me, r);
  ...
  function xn(r) {
    const e = Ne(rs, r);
    if (e.own) {
      const t = Ht.get(e.rep);
      t ? (t[H] && t[H](), Ht.delete(e.rep)) : Xt[X] && Xt[X](e.rep);
    }
  }
  function On(r) {
    const e = Ne(ur, r);
    if (e.own) {
      ...
      t ? (t[H] && t[H](), ft.delete(e.rep)) : lt[X] && lt[X](e.rep);
    }
  }
  let ns;
  function Sn(r, e) {
    ...
    var { name: f, noTypescript: p, instantiation: o, importBindings: s, map: c, compat: y, noNodejsCompat: A, base64Cutoff: h, tlaCompat: v, validLiftingOptimization: _, tracing: S, noNamespacedExports: T, guest: ee, multiMemory: R, asyncMode: I } = e, Ee = pe(f, q, l), le = K;
    ...
    var Te = s;
    if (Te == null) u(l).setInt8(t + 20, 0, true);
    else {
      const B = Te;
    ...
    if (xt == null) u(l).setInt8(t + 60, 0, true);
      ...
      switch (st.tag) {
        ...
        case "jspi": {
          ...
          var { imports: xs, exports: Os } = F, Ot = xs, kr = Ot.length, mr = q(0, 0, 4, kr * 8);
          for (let W = 0; W < Ot.length; W++) {
            const Ae = Ot[W], Ge = mr + W * 8;
            var Ss = pe(Ae, q, l), Rs = K;
            u(l).setInt32(Ge + 4, Rs, true), u(l).setInt32(Ge + 0, Ss, true);
          }
          u(l).setInt32(t + 72, kr, true), u(l).setInt32(t + 68, mr, true);
          var St = Os, yr = St.length, Ar = q(0, 0, 4, yr * 8);
          for (let W = 0; W < St.length; W++) {
            const Ae = St[W], Ge = Ar + W * 8;
            var Ls = pe(Ae, q, l), Ns = K;
            u(l).setInt32(Ge + 4, Ns, true), u(l).setInt32(Ge + 0, Ls, true);
          }
          u(l).setInt32(t + 80, yr, true), u(l).setInt32(t + 76, Ar, true);
          break;
        }
        default:
          throw new TypeError(`invalid variant tag value \`${JSON.stringify(st.tag)}\` (received \`${st}\`) specified for \`AsyncMode\``);
      }
    }
    const te = ns(t);
    let Rt;
    switch (u(l).getUint8(te + 0, true)) {
      case 0: {
        ...
        var Gs = u(l).getInt32(te + 24, true), Js = u(l).getInt32(te + 20, true), Ir = [];
        for (let B = 0; B < Gs; B++) {
          const F = Js + B * 12;
    ...
    const at = Rt;
    if (as(te), typeof at == "object" && at.tag === "err") throw new Da(at.val);
    return at.val;
  }
  let os = false;
  const Rn = (() => {
    let r = function* () {
      ...
      ({ exports: C } = yield ot(yield o)), { exports: ue } = yield ot(yield f, {
        ...
        "wasi:filesystem/types@0.2.3": {
          ...
          "[resource-drop]directory-entry-stream": _n,
      ...
      }), l = ue.memory, se = D.cabi_import_realloc, { exports: Tn } = yield ot(yield s, {
        "": {
          $imports: C.$imports,
          0: D.path_open,
          1: D.fd_readdir,
  ...
  class mt extends M {
    ...
    maybe_null() {
      return this._ty instanceof mt ? !this._ty.maybe_null() : false;
    }
  }
  class ls extends M {
    constructor(e) {
  ...
  const _yt = class _yt extends M {
    constructor() {
      super(...arguments);
      __publicField(this, "_id", _yt._counter++);
  ...
  class ks extends M {
    constructor(e, t, n = []) {
      super(), this._name = e, this._fields = t, this._resources = n;
    }
    accept(e, t) {
  ...
  const ms = new is(), ys = new dr(), Nn = new cs(), Mn = new tt(8), Fn = new tt(16), Qn = new tt(32), Un = new tt(64), Pn = new rt(8), Wn = new rt(16), Dn = new rt(32), Vn = new rt(64), zn = new fr(32), Xn = new fr(64);
  function As(r) {
    return new mt(r);
  }
  function Hn(r) {
  ...
  function Gn(r) {
    return new pr(Object.fromEntries(r.map((e) => [
      e,
      ys
    ])));
  }
  ...
  function Eo(r, e, t) {
    return e.random && (r instanceof dr || r instanceof br || t.value === "") ? r.accept(new Io(), t) : r.accept(new go(), t);
  }
  function vr(r) {
    return r.accept(new wo(), null);
  }
  const { getEnvironment: To } = bt, { exit: _o } = ar, { getStderr: Bo } = ir, { getStdin: Co } = nr, { getStdout: jo } = or, { getDirectories: $o } = rr, { Descriptor: Oe, filesystemErrorCode: xo } = ct, { Error: Se } = Kt, { InputStream: Zt, OutputStream: oe } = Ye, { getRandomBytes: Oo } = be, $r = (r) => WebAssembly.compile(typeof Buffer < "u" ? Buffer.from(r, "base64") : Uint8Array.from(atob(r), (e) => e.charCodeAt(0)));
  ...
  let O = [], Pt = new DataView(new ArrayBuffer());
  const m = (r) => Pt.buffer === r.buffer ? Pt : Pt = new DataView(r.buffer), Ro = typeof process < "u" && process.versions && process.versions.node;
  let Wt;
  async function xr(r) {
    return Ro ? (Wt = Wt || await fe(() => import("./__vite-browser-external-BIHI7g3E.js"), []), WebAssembly.compile(await Wt.readFile(r))) : fetch(r).then(WebAssembly.compileStreaming);
  }
  function Ie(r) {
  ...
  const Lo = Object.prototype.hasOwnProperty, it = WebAssembly.instantiate, re = 1 << 30;
  function ce(r, e) {
    const t = r[0] & -1073741825;
  ...
  function Gt(r, e, t) {
    if (typeof r != "string") throw new TypeError("expected a string");
    if (r.length === 0) return Je = 0, 1;
    let n = No.encode(r), a = e(0, 0, 1, n.length);
    return new Uint8Array(t.buffer).set(n, a), Je = n.length, a;
  }
  let L, Be;
  const ye = [
    re,
  ...
  function Qo() {
    const r = Co();
    if (!(r instanceof Zt)) throw new TypeError('Resource error: Not a valid "InputStream" resource.');
    var e = r[$];
    if (!e) {
      const t = r[N] || ++Fo;
      Jt.set(t, r), e = ce(hs, t);
    }
    return e;
  }
  function Uo() {
  ...
  let Ce, k, xe;
  function Wo(r) {
    var t = To(), n = t.length, a = xe(0, 0, 4, n * 16);
    for (let c = 0; c < t.length; c++) {
      const y = t[c], A = a + c * 16;
      var [i, d] = y, f = Gt(i, xe, k), p = Je;
      m(k).setInt32(A + 4, p, true), m(k).setInt32(A + 0, f, true);
      var o = Gt(d, xe, k), s = Je;
    ...
    switch (d.tag) {
      case "ok": {
        ...
        if (h == null) m(k).setInt8(e + 32, 0, true);
          ...
          var { seconds: v, nanoseconds: _ } = U;
          m(k).setBigInt64(e + 40, Qe(v), true), m(k).setInt32(e + 48, Dt(_), true);
        }
        var S = c;
        if (S == null) m(k).setInt8(e + 56, 0, true);
          ...
          var { seconds: T, nanoseconds: ee } = U;
          m(k).setBigInt64(e + 64, Qe(T), true), m(k).setInt32(e + 72, Dt(ee), true);
        }
        var R = y;
        if (R == null) m(k).setInt8(e + 80, 0, true);
          ...
          var { seconds: I, nanoseconds: Ee } = U;
          m(k).setBigInt64(e + 88, Qe(I), true), m(k).setInt32(e + 96, Dt(Ee), true);
        }
        break;
      }
      case "err": {
  ...
  function ni(r) {
    const e = At(hs, r);
    if (e.own) {
      const t = Jt.get(e.rep);
      t ? (t[we] && t[we](), Jt.delete(e.rep)) : Zt[he] && Zt[he](e.rep);
    }
  }
  let Is;
  function oi(r) {
  ...
  const ii = (() => {
    let r = function* () {
      ...
      }), k = Be.memory, xe = Ce.cabi_import_realloc, { exports: ti } = yield it(yield s, {
        "": {
          $imports: L.$imports,
          0: Ce.fd_write,
          1: Ce.random_get,
  ...
  async function li(r) {
    ...
    for (const d of r.imports) if (!d.startsWith("@bytecodealliance/preview2-shim/")) {
      const f = Ts[d], o = await import(URL.createObjectURL(new Blob([
        f.value
      ], {
        type: "text/javascript"
      }))).then(async (m2) => {
  ...
  function di() {
    document.querySelector("#preselectedWasmFile").addEventListener("change", async (t) => {
      ...
      if (n && n.length > 0) {
        const a = n[0];
        a.type === "application/wasm" ? Vt(a) : console.error("Please drop a valid .wasm file.");
      }
    });
  }
  function fi() {
    ...
    for (const e of Es) {
      ...
      for (const a of e._resources) {
        ...
        for (const [p, o] of a.get_static_funcs()) {
          ...
          d.appendChild(s), qt(s, t, p, o, f);
        }
      }
      for (const [a, i] of Object.entries(e._fields)) {
        const d = document.createElement("li");
        r.appendChild(d), qt(d, t, a, i);
      }
    }
  }
  function pi(r, e) {
    ...
    for (const [f, p] of t.get_method_funcs()) {
      ...
      d.appendChild(o), qt(o, "UNNAMED", f, p, {
        instance: a,
        ...r
      });
    }
  }
  function qt(r, e, t, n, a) {
  ...
  `;
    ...
    for (const a of r.imports) {
      ...
      if (t.appendChild(i), !a.startsWith("@bytecodealliance/preview2-shim/")) {
        ...
        d.style.width = "28em", d.style.height = "3em", a === "docs:adder/add" && (d.value = "export function add(a, b) { return a + b }"), Ts[a] = d, i.appendChild(d);
      }
    }
    n.onclick = async () => {
      await li(r), fi();
